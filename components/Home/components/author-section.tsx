...
export const AuthorSection = () => {
  return (
    ...
    //   <div className="max-w-6xl w-full mx-auto flex gap-32 my-32">
    //     <div className="flex-1 flex flex-col gap-10">
    //       <h2 className="text-4xl font-medium">Hi, I'm Vedant Lamba</h2>
    //       <div
    //         className={`${crimson.className} flex flex-col gap-10 text-2xl tracking-wide leading-[1.5] text-balance`}
    //       >
    //         <p>
    ...
    //       </h3>
    //       <div className="flex flex-col gap-10 text-xl tracking-wide leading-[1.5] text-balance">
    //         <p>
    ...
    <div className="border-y">
      <div className="max-w-6xl mx-auto grid grid-cols-2">
        <div className="border-r flex flex-col gap-10 py-28 pr-5 pl-10 md:pl-0">
          <h2 className="text-4xl font-medium">Hi, I'm Vedant Lamba</h2>
          <div
