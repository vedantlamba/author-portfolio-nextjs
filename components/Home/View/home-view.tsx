...
export const Book = () => {
  return (
    <div className="relative flex justify-center items-center h-[120px] translate-y-10">
      {/* Pages */}
      <div className="absolute inset-0 flex items-center justify-center">
        {/* Left */}
        <div className="absolute w-[190px] aspect-[1/1.414] bg-white border rounded-sm -translate-x-40">
          <img
            src="/book-page-1.png"
      ...
      {/* Book */}
      <div className="absolute w-[240px] aspect-[1/1.414] rounded-sm overflow-hidden z-20">
        <img
...
export const NewsletterBox = () => {
  return (
    <div className="max-w-6xl w-full mx-auto flex flex-col gap-8 items-center justify-center text-center mt-56 mb-60">
